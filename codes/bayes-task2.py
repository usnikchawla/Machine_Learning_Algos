...
plt.ylabel('Accuracy')
plt.title('MDA + Bayes + expression classification')
plt.show()
...
plt.plot(['5', '10', '20'], train_acc, '-o', label='Train data')
plt.plot(['5', '10', '20'], test_acc, '-o', label='Test data')
plt.legend()
plt.xlabel('component dimension from 504 to x')
plt.ylabel('Accuracy')
plt.title('PCA + Bayes + expression classification')
plt.show()
