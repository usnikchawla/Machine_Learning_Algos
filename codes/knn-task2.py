...
for k in [5, 10]:
    ...
    plt.plot(['1' ,'5', '15', '25', '45'], train_acc, '-o', label='Train data.  reduced dimension = {}'.format(k))
    plt.plot(['1' ,'5', '15', '25', '45'], test_acc, '-o', label='Test data. reduced dimanesion = {}'.format(k))
    

plt.legend()
plt.xlabel('#  K nearest neighbors')
plt.ylabel('Accuracy')
plt.title('MDA + KNN + expression classification')
plt.show()
...
for k in [5, 10, 20]:
    ...
    plt.plot(['1' ,'5', '15', '25', '45'], train_acc, '-o', label='Train data. reduced dimension = {}'.format(k))
    plt.plot(['1' ,'5', '15', '25', '45'], test_acc, '-o', label='Test data. reduced dimension = {}'.format(k))
...
plt.xlabel('# K nearest neighbors')
plt.ylabel('Accuracy')
plt.title('PCA + KNN + expression clasification')
plt.show()
